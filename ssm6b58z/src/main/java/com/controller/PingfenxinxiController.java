...
public class PingfenxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,PingfenxinxiEntity pingfenxinxi, 
		...
		if(tableName.equals("yonghu")) {
			pingfenxinxi.setYonghuming((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<PingfenxinxiEntity> wrapper = new EntityWrapper<PingfenxinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = pingfenxinxiService.selectCount(wrapper);
