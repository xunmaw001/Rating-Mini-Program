  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        this.ruleForm.pingfen = 0
	    this.ro.pingfen = false;
      }
      // 获取用户信息
      this.$http({
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.pingfen = parseFloat(objcross.pingfen) + parseFloat(this.ruleForm.pingfen)
                }
	      this.$http({
		  url: `${table}/update`,
		  method: "post",
