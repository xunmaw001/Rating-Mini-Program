<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.chanpinshipin" label="产品视频" prop="chanpinshipin">
          <file-upload
          tip="点击上传产品视频"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.chanpinshipin?ruleForm.chanpinshipin:''"
          @change="chanpinshipinUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.chanpinshipin" label="产品视频" prop="chanpinshipin">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.chanpinshipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='chanpinshipin'){
            this.ruleForm.chanpinshipin = obj[o];
	    this.ro.chanpinshipin = true;
            continue;
          }
          if(o=='pingfen'){
	...
	this.ruleForm.chanpinjieshao = this.ruleForm.chanpinjieshao.replace(reg,'../../../ssm6b58z/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.chanpinshipin!=null) {
		this.ruleForm.chanpinshipin = this.ruleForm.chanpinshipin.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    chanpinshipinUploadChange(fileUrls) {
	this.ruleForm.chanpinshipin = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
